...
class _RegisterPetViewState extends State<RegisterPetView> {
  ...
  Future<void> _cargarRazas() async {
    try {
      final razas = await ApiService.getRazas();
      setState(() {
        _razas = razas;
  ...
  Future<void> _onFinalizar() async {
    ...
    try {
      ...
      final clienteId = await ApiService.createCliente(
      ...
      final animal = AnimalModel(
        ...
        numeroChip: _chipCtrl.text.trim().isNotEmpty
            ? _chipCtrl.text.trim()
            : null,
        descripcion: _observacionesCtrl.text.trim(),
      );

      await ApiService.createAnimal(animal.toJson());
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    // Botón Finalizar
                    _buildPrimaryButton(
                      label: _enviando ? 'Registrando...' : 'Finalizar registro',
